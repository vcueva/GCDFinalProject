...
Measure columns have a real value range with:
		a. Acceleration (from accelerometer) in standard gravity units 'g' (a g unit is the acceleration for gravity acceleration).
		b. Angular velocity (from gyroscope) in radians/second.
